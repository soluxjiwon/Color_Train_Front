...
function MyPaletteCheckModal({ modalIsOpen, closeCheckModal, hexColors}){
    ...
    return (
        ...
        >
          {/*모달창 닫기 버튼*/}
          <button className="closebutton" onClick={closeCheckModal}>X</button>  
...
export default MyPaletteCheckModal;