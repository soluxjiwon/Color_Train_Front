...
async function checkColors(foregroundColor, backgroundColor, callback) {
  return new Promise((resolve) => {
      ...
      // Get RGBA
      var foregroundR = hexToRgb(foregroundColor).r
      var foregroundG = hexToRgb(foregroundColor).g
      var foregroundB = hexToRgb(foregroundColor).b
      var foregroundColorRgba = ["" + foregroundR + "","" + foregroundG + "","" + foregroundB + "","0"]
    
      var backgroundR = hexToRgb(backgroundColor).r
      var backgroundG = hexToRgb(backgroundColor).g
      var backgroundB = hexToRgb(backgroundColor).b
